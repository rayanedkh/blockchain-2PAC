...
class Com:
    ...
    def __init__(self, id=None, port=None, peers=None, delay=0):
        ...
        self.sock.settimeout(1)     #fermeture automatique du socket 
    ...
    def close_socket(self, sock):
        ...
        if sock:
            try:
                ...
                if not self.stop_event.is_set():
                    print(f"Exception pendant l'éteignage du socket client: {e}")
            try:
                sock.close()
            except Exception as e:
                if not self.stop_event.is_set():
                    print(f"Exception pendant la fermeture du socket client: {e}")
