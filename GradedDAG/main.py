...
def write_result(node):
    ...
    node.log_data['Envoie Block']=node.datas_broadcastBlock
    node.log_data['Receptions Block']=node.datas_block
    node.log_data['Envoie Echo']=node.datas_broadcastEcho
    node.log_data['Receptions Echo']=node.datas_echo
    node.log_data['Envoie Ready']=node.datas_broadcastReady
